...
window.CONFIG = {
  ...
  palabras: [
    "Te amo", "Mi amor", "Siempre juntos", "Me encantas",
    "Eres mi luz", "Mi girasol", "Contigo todo", "Mi persona favorita",
    "Mi lugar seguro", "Mi hogar", "Te elijo", "Gracias por existir",
  ],
  ...
  /* ===================================================================
     PLANETAS  ·  Cada uno se puede tocar y abre una tarjeta.
     Campos:
       nombre    → título del planeta y de la tarjeta
       estilo    → girasol | anillos | bandas | crateres | corazon |
                   nebulosa | lunas | estrella | tierra
       color     → color principal (hex). "color2" es opcional (nebulosa/tierra)
       tam       → tamaño del planeta (unos 45 a 75)
